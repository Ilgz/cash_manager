...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i8.ExpenseFormCubit>(() => _i8.ExpenseFormCubit());
    gh.lazySingleton<_i9.ITransactionRepository>(
        () => _i10.TransactionRepository(
              gh<_i3.Box<_i5.ExpenseDto>>(instanceName: 'expense'),
              gh<_i3.Box<_i4.IncomeDto>>(instanceName: 'income'),
            ));
    gh.factory<_i11.ExpenseActorCubit>(
        () => _i11.ExpenseActorCubit(gh<_i9.ITransactionRepository>()));
    gh.factory<_i12.ExpenseWatcherCubit>(
        () => _i12.ExpenseWatcherCubit(gh<_i9.ITransactionRepository>()));
    return this;
  }
}
