...
class ExpenseFormState with _$ExpenseFormState {
  ...
  const factory ExpenseFormState({required Expense expense,required bool showErrorMessages,required Option<Unit> authFailureSuccessOption})= _ExpenseFormState;
}
